    ...
    return ActivityPack(
        ...
        pages=[
            ActivityPage(
                ...
                components=[
                    MatchingCard("Brahma", "leads the demigods", "who"),
                    MatchingCard("Shiva", "joins the prayers", "who"),
                    MatchingCard("Narada", "great sage and devotee", "who"),
                    MatchingCard("other demigods", "offer respectful prayers", "who"),
                    MatchingCard("Devaki", "carries Krishna within her", "who"),
                ],
                story_connection=connection,
            ),
            ActivityPage(
            ...
            ActivityPage(
                ...
                page_type="PRAYER_WHEEL",
                instructions=[
                    "Fill five lotus petals.",
                    "Younger path: draw on each petal.",
                    "Older path: write one or two sentences on each petal.",
                    "Discuss one petal with your family.",
                ],
                components=[
        ...
        age_variants={
            "ages_6_8": "Match with lines or pictures, then draw on the lotus petals.",
            "ages_9_13": "Write one reason for each match and one or two sentences on each petal.",
        },
