...
# Needs public Stories 001-009 bytes; provisioned in CI from the approved
# bhava-content-001-009-v1 GitHub Release.
...
EXPECTED_CONTENT_RELEASE = {
    ...
    "tests/test_launch_story_hash_guard.py::test_story_010_absent_from_output",
    ...
    "tests/test_unicode_printable_copyright.py::test_story_010_absent_from_public_content",
} | {
