...
def _settings(
    ...
    *,
    ...
    return Settings(
        ...
        openai_repair_model="gpt-4.1",
        openai_visual_qa_model="gpt-4.1-mini",
        ...
        image_reference_line_art=None,
        image_reference_poster=None,
        image_reference_required=False,
        image_candidates_per_type=2,
        image_max_repair_rounds=2,
        image_min_acceptance_score=86,
        pipeline_max_repair_attempts=4,
        debug_artifacts=False,
        image_use_style_references=False,
