...
4. Exactly seven final local files; every file opens/parses.
...
8. Drive folder exists with exactly seven files and no intermediates; links match caption/manifest.
